namespace M1Vm2.ViewModels
{
    ...
    public class PersonViewModel : ViewModelBase
    {
        ...
        {
            Model = model;
            System.Diagnostics.Trace.WriteLine(String.Format("Ino - VM: Konstruktor Person ({0} - {1})", Id, GetHashCode()));
            System.Diagnostics.Trace.WriteLine(String.Format("Ino - VM: Konstruktor Model ({0} - {1})", Id, Model.GetHashCode()));
        ...
        public string Name
        {
            ...
            set
            {
                ...
                System.Diagnostics.Trace.WriteLine(String.Format("Ino - VM: Name set to {0} ({1} - {2})", value, Id, GetHashCode()));
        ...
        {
            //System.Diagnostics.Trace.WriteLine(String.Format("Ino - VM: Start EndEdit ({0} - {1})", Id, GetHashCode()));
            base.OnEndEdit(e);
            System.Diagnostics.Trace.WriteLine(String.Format("Ino - VM: End EndEdit ({0} - {1})", Id, GetHashCode()));
        }
        ...
        {
            System.Diagnostics.Trace.WriteLine(String.Format("Ino - VM: Start SaveAsync ({0} - {1})", Id, GetHashCode()));
            return base.SaveAsync();
        }

        protected override Task<bool> CancelAsync()
        {
            System.Diagnostics.Trace.WriteLine(String.Format("Ino - VM: Start CancelAsync ({0} - {1})", Id, GetHashCode()));
